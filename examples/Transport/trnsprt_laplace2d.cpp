...
int main()
{
    ...
    //bc.assignDBC(mesh, "mesh/PlateWithHole2D/top_400.dat",0);
    //bc.assignDBC(mesh, "mesh/PlateWithHole2D/bottom_400.dat",10);
    
	bc.assignDBC(mesh, "mesh/PlateWithHole2DO2/top_1200.dat",0);
    bc.assignDBC(mesh, "mesh/PlateWithHole2DO2/bottom_1200.dat",10);
